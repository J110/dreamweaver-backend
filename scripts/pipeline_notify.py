...
def _build_html(state: dict, log_file: str = "", elapsed: float = 0) -> str:
    ...
    <tr><td><b>Covers</b></td><td>{len(covers_flux)} FLUX generated, {len(covers_fail)} failed</td></tr>
